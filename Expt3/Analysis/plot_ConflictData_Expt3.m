...
plot(1000*[0 max(xplot)],[.25 .25],'k')
shadedErrorBar(1000*xplot,nanmean(d{3}.phit_col),seNan(d{3}.phit_col),'g',1)
...
plot(1000*[0 max(xplot)],[.25 .25],'k')
shadedErrorBar(1000*xplot,nanmean(d{4}.incongruent.phit_spat),seNan(d{4}.incongruent.phit_spat),'r',1)
shadedErrorBar(1000*xplot,nanmean(d{4}.incongruent.phit_col),seNan(d{4}.incongruent.phit_col),'b')
shadedErrorBar(1000*xplot,nanmean(d{4}.incongruent.phit_symb),seNan(d{4}.incongruent.phit_symb),'g',1)
%shadedErrorBar(1000*xplot,nanmean(d{2}.phit_symb),seNan(d{2}.phit_symb),'b')
axis([0 1000*max(xplot) 0 1])
xlabel('Preparation Time')
ylabel('Proportion')
...
shadedErrorBar(1000*xplot,nanmean(d{4}.incongruent.phit_symb),seNan(d{4}.phit_symb),'b--')
shadedErrorBar(1000*xplot,nanmean(d{4}.incongruent.phit_col),seNan(d{4}.phit_col),'g--')
axis([0 1000*max(xplot) 0 1])
...
plot(1000*[0 max(xplot)],[.25 .25],'k')
shadedErrorBar(1000*xplot,nanmean(d{4}.incongruent.phit_spat),seNan(d{4}.incongruent.phit_spat),'r')
shadedErrorBar(1000*xplot,nanmean(d{4}.incongruent.phit_symb),seNan(d{4}.incongruent.phit_symb),'g')
shadedErrorBar(1000*xplot,nanmean(d{4}.incongruent.phit_col),seNan(d{4}.incongruent.phit_col),'b')
axis([0 1000*max(xplot) 0 1])