...
%
clear all
subjname = {'200_387','200_375','200_365','200_379','200_392','200_396','200_367'};
...
for s = 1:length(subjname);
    % day 1
    %
    data{s,1} = loadTRsubjData(subjname{s},{'spat_forcedRT_1','spat_forcedRT_2','spat_forcedRT_3'});
    data{s,2} = loadTRsubjData(subjname{s},{'arrow_forcedRT_1','arrow_forcedRT_2','arrow_forcedRT_3'});
    data{s,3} = loadTRsubjData(subjname{s},{'col_forcedRT_1','col_forcedRT_2','col_forcedRT_3'});
   % data{s,4} = loadTRsubjData(subjname{s},{'arrow_spat_forcedRT_1','arrow_spat_forcedRT_2'});
   % data{s,5} = loadTRsubjData(subjname{s},{'col_spat_forcedRT_1','col_spat_forcedRT_2'});
   % data{s,6} = loadTRsubjData(subjname{s},{'col_arrow_forcedRT_1','col_arrow_forcedRT_2'});
    data{s,4} = loadTRsubjData(subjname{s},{'col_all_forcedRT_1','col_all_forcedRT_2','col_all_forcedRT_3','col_all_forcedRT_4','col_all_forcedRT_5','col_all_forcedRT_6'});  
...
for s=1:length(subjname)
    ...
    for i=[2 4] % arrow blocks
        data{s,i}.goalDir_symb = symb_key(s,data{s,i}.tFile(:,11)-8*(data{s,i}.tFile(:,11)>0)+1);
    end
