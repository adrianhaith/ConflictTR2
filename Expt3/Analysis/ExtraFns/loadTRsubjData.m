...
data.goalAng = -tFile(:,14); % goal angle
data.spatAng = -tFile(:,10); % angle of spatial cue
...
data.reachDir_spat = data.reachDir'-data.spatAng;
data.reachDir_spat = mod(data.reachDir_spat,360)-180;

data.reachDir_goal = data.reachDir'-data.goalAng;
data.reachDir_goal = mod(data.reachDir_goal,360)-180;
