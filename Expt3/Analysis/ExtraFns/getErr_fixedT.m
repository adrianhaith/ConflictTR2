...
for i=1:data.Ntrials
    ...
    d2 = sum(pos_filt.^2);
    [xx iEnd(i)] = max(d2(51:end));
    iEnd(i) = iEnd(i)-1+50; % subtract 1 to use as index for velocity
...
if(data.tFile(1,7)) % if Free RT
    data.RT = data.iInit/130 - 1200/1000 - .1;
else
